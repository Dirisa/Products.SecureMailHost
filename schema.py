...
#
# RCS-ID:       $Id: schema.py,v 1.8 2004/10/20 20:49:48 dreamcatcher Exp $
...
PFMschema += Schema((
    ...
    StringField('recipient_email',
                accessor='getRecipientEmail',
                mutator='setRecipientEmail',
    ...
    LinesField('cc_recipients',
               accessor='getCCRecipients',
               mutator='setCCRecipients',
        widget=LinesWidget(
    ...
    LinesField('bcc_recipients',
               accessor='getBCCRecipients',
               mutator='setBCCRecipients',
        widget=LinesWidget(
    ...
    LinesField('additional_headers',
               accessor='getAdditionalHeaders',
               mutator='setAdditionalHeaders',
    ...
    TextField('body_footer',
              accessor='getBodyFooter',
              mutator='setBodyFooter',
    ...
    LinesField('form_buttons',
               accessor='getFormButtons',
               mutator='setFormButtons',
...
##        ),
    ...
    StringField('cpyaction',
                accessor='getCPYAction',
                mutator='setCPYAction',
    ...
    StringField('sent_title',
                accessor='getSentTitle',
                mutator='setSentTitle',
    ...
    TextField('sent_message',
              accessor='getSentMessage',
              mutator='setSentMessage',
    ...
    StringField('sent_redirect',
                accessor='getSentRedirect',
                mutator='setSentRedirect',
