...
# RCS-ID:       $Id: PloneFormMailer.py,v 1.15 2004/10/21 21:26:14 dreamcatcher Exp $
...
class PloneFormMailer(BaseContent, TALESLines, TALESString):
    ...
    security.declareProtected(ModifyPortalContent, 'setBodyPT')
