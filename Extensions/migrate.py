...
$Id: migrate.py,v 1.27 2004/07/23 15:32:07 ajung Exp $
"""
...
THIS SCRIPT IS ONLY WORKING FOR PLONECOLLECTORNG 1.1X BUT NOT FOR V 1.2.X.
TO PERFORM A MIGRATION FROM CMFCOLLECTORNG TO PCNG 1.2 YOU MUST MIGRATE YOUR
CMFCOLLECTORNG INSTANCE FIRST TO PCNG 1.1.X AND THEN UPGRADE THE PCNG INSTANCE
FROM 1.1 TO 1.2
"""
